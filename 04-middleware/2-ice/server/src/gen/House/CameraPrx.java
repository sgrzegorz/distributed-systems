...
{
    default String getScreen()
    {
        return getScreen(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getScreen(java.util.Map<String, String> context)
    {
        return _iceI_getScreenAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getScreenAsync()
    {
        return _iceI_getScreenAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getScreenAsync(java.util.Map<String, String> context)
    {
        return _iceI_getScreenAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getScreenAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getScreen", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
